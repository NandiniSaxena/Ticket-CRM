...
export default function MyTickets() {
    const { auth, tickets: initialTickets,stats, recentTickets, flash } = usePage().props;
    ...
    const currentTickets = tickets.slice(startIndex, startIndex + perPage);
    ...
    return (
        <>
            <Head title="All My Tickets - Agent Panel" />
            ...
            <div className="topbar">
                <div><strong>Agent / All My Tickets</strong></div>
            ...
            <div className="content">
                <h2 className="mb-4">All My Tickets ({totalTickets})</h2>
                    ...
                    {totalPages > 1 && (
                        <div className="card-footer bg-white d-flex justify-content-between align-items-center">
                            <div className="text-muted small">
                                Showing {startIndex + 1} to {Math.min(startIndex + perPage, totalTickets)} of {totalTickets} tickets
                            </div>
