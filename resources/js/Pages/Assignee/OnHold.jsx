...
export default function OnHold() {
    const { auth, stats, tickets, recentTickets, flash } = usePage().props;
    ...
    return (
        <>
            <Head title="On Hold Tickets - Agent Panel" />
            ...
            <div className="topbar">
                <div><strong>Agent / On Hold Tickets</strong></div>
            ...
            <div className="content">
                <h2 className="mb-4">On Hold Tickets ({tickets.length})</h2>
                                ...
                                <div className="row mb-4">
                                    ...
                                    <div className="col-md-6 text-md-end">
                                        ...
                                        <p><strong>Status:</strong>
                                            <span className="badge bg-secondary ms-2">On Hold</span>
                                        </p>
                                    </div>
                                </div>
                                <hr />
