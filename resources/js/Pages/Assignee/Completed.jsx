...
export default function Completed() {
    ...
    return (
        <>
            <Head title="Completed Tickets - Agent Panel" />
            ...
            <style>{`
                ...
                .topbar { height: 60px; background: #fff; margin-left: 250px; display: flex; align-items: center; justify-content: space-between; padding: 0 30px; border-bottom: 1px solid #dcdcdc; position: fixed; width: calc(100% - 250px); z-index: 999; transition: margin-left 0.3s, width 0.3s; }
                .content { margin-left: 260px; padding: 90px 30px 30px; transition: margin-left 0.3s; }
                .hamburger { display: none; font-size: 1.8rem; cursor: pointer; margin-right: 15px; }
            ...
            <div className="topbar">
                <div className="d-flex align-items-center">
                    ...
                    <strong>Agent / Completed Tickets</strong>
                </div>
                <div className="d-flex align-items-center">
            ...
            <div className="content">
                <h2 className="mb-4">Completed Tickets ({tickets.length})</h2>
